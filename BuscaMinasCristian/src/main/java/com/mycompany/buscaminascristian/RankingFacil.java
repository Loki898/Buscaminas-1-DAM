...
/**
 * Clase encargada de gestionar el ranking de la dificultad facil que guardará
 * la información del fichero RankingFacil para su futura muestra por pantalla
 *
 * @author Cristian
 */
public class RankingFacil {

    private IntegerProperty facil = new SimpleIntegerProperty();//Property que guarda el tiempo del jugador para su correcta representación en el tableview
     ...
     * @param tiempo
     */
    public RankingFacil(String jugador, String imagen, int tiempo) {
        this.jugador.setValue(jugador);
        this.pathImagen.setValue(imagen);
        facil.setValue(tiempo);
    }

    /**
     * Método que devuelve la FacilProperty que recoje el tiempo
     *
     * @return IntegerProperty
     */
    public final IntegerProperty FacilProperty() {
        return this.facil;
    }
     ...
     * @return int
     */
    public final int getFacil() {
        return this.FacilProperty().get();
    }
     ...
     * @param tiempo
     */
    public final void setFacil(int tiempo) {
        this.FacilProperty().set(tiempo);
    }
